...
3. ~~Собрать Grafana-дашборд~~ — сделано: ADR-005 реализован (`monitoring/`, три provisioned-дашборда). Осталось снять скриншоты на поднятом стенде для пояснительной записки.
